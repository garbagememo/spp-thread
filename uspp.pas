...
type
  ...
  TRenderClass=class
     sph:TList;
     cam:CamRecord;
     constructor Create(sph_:TList;cam_:CamRecord);
...
constructor TRenderClass.Create(sph_:TList;cam_:CamRecord);
begin
   sph:=sph_;
   cam:=cam_;
end;
...
function TRenderClass.intersect(const r:RayRecord;var t:real; var id:integer):boolean;
var 
  n,d:real;
  i:integer;
begin
...
function TRenderClass.radiance(const r:RayRecord;depth:integer):Vec3;
var
  id:integer;
  obj:SphereClass;
